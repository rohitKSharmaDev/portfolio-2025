...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('rohitksharma@gmail.com');
    setCopied(true);
  };
    ...
    >
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          ...
          <div
            className={`font-sans text-lg lg:text-2xl max-w-96 font-bold text-neutral-600 dark:text-neutral-200 z-10`}
          >
            {title}
          </div>
